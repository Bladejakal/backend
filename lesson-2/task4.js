class TimersManager {
    ...
    start() {
        ...
        // set maximum time of work
        setTimeout(function (self) {
            console.log(`Maximum time ( ${self.timeout} ) of work reached`);
            self.stop();
        }, this.timeout, this);
    }
    ...
    resume(name) {
        ...
        for (const [key, value] of Object.entries(this.timers)) {
            ...
            if (timer.input.name === name) {
                ...
                // define max timeout
                if ((timer.input.delay + this.timeoutDeley) > this.timeout) {
                    this.timeout = timer.input.delay + this.timeoutDeley;
                }
